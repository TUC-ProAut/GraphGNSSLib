...
/**
	 ...
	 * @return none
	 */
    bool findMasterSatellite(int sat_id, gnss_msgs::GNSS_Raw_Array user_gnss_data, gnss_msgs::GNSS_Raw& master_sv, gnss_msgs::GNSS_Raw& i_sv)
    {   
	 ...
	 * @return none
	*/
    void findClosestEpoch(double t, std::map<double, gnss_msgs::GNSS_Raw_Array> gnss_raw_map, gnss_msgs::GNSS_Raw_Array& cloest_epoch_gnss)
    {
        std::map<double, gnss_msgs::GNSS_Raw_Array>::iterator gnss_iter;
	 ...
	 * @return none
	*/
    void findSatellitewithSameId(double id, gnss_msgs::GNSS_Raw_Array gnss_data, gnss_msgs::GNSS_Raw& same_id_sv)
    {
